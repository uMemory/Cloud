...
while read -r HOST; do
  ...
  if [[ "${PROFILE}" -eq 0 ]]; then
    ...
    NODE_DISK_WRITE_MB="${DISK_WRITE_MB:-24}"
    NODE_DISK_INTERVAL="${DISK_INTERVAL:-1.3}"
    ...
    NODE_DISK_WRITE_MB="${DISK_WRITE_MB:-32}"
    NODE_DISK_INTERVAL="${DISK_INTERVAL:-1.7}"
    ...
    NODE_DISK_WRITE_MB="${DISK_WRITE_MB:-40}"
    NODE_DISK_INTERVAL="${DISK_INTERVAL:-2.1}"
